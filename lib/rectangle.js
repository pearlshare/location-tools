...
function Rectangle () {
  ...
  if (!coords.n || !coords.e || !coords.s || !coords.w) {
    throw new Error("invalid Rectanlge constructor arguments" + args);
  }
...
Rectangle.prototype.toCircle = function () {
  ...
  var radius = height > width ? getDistance(bounds.w, bounds.e) / 2 : getDistance(bounds.n, bounds.s) / 2;

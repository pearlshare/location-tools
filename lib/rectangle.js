...
/**
 * Get a circle which contains the rectangle
 * @returns {Circle} location tools Circle object
 */
Rectangle.prototype.toCircle = function () {
  console.warn("DEPRECIATION WARNING - use toInnerCircle or toOuterCircle");
  return this.toOuterCircle.call(this, arguments);
};
 ...
 * @returns {Circle} location tools Circle object
 */
Rectangle.prototype.toOuterCircle = function () {
  var Circle = require("./circle"); // FIXME - circular reference
  var dimensions = this.getDimensions();

  // Radius is max of width or height / 2
  var diameter = dimensions.height > dimensions.width ? dimensions.height : dimensions.width;
...
/**
 * Get a circle contained within the rectangle
 * @returns {Circle} location tools Circle object
 */
Rectangle.prototype.toInnerCircle = function () {
  var Circle = require("./circle"); // FIXME - circular reference
  var dimensions = this.getDimensions();
